    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100">
                ...
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Product Not Found</h1>
                <p className="text-lg text-gray-600 mb-6">The product you're looking for doesn't exist or has been moved.</p>
