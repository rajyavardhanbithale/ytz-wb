        ...
        <>
            <Dialog>
                <DialogTrigger asChild>
                    <span className="flex items-center text-base bg-blue-600 px-4 py-2 rounded-lg text-white hover:bg-blue-700 transition-colors duration-300">
...
function ProductDelete(props: { productID: string }) {
    ...
    return (
        <>
            <Dialog>
                <DialogTrigger>
                    <span className="flex items-center text-base bg-red-600 px-4 py-2 rounded-lg text-white hover:bg-red-700 transition-colors duration-300">
