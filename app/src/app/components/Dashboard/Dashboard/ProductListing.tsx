...
export default function ProductListing() {
    ...
    return (
        <>
            <div className="min-h-screen p-6 flex w-full justify-center flex-col items-center ">
                <h1 className="text-4xl font-bold mb-6 text-center">
                    Product List
                </h1>
                <div className="mt-5 grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-6 m-10">
                    {products &&
